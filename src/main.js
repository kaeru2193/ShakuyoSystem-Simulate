...
const phunCheck = document.getElementById("phun");
...
const drawFrame = () => {
    ...
    viewRange = Math.pow(10, (2.1 - Number(zoomSlider.value)));
    astroDay += (Math.pow(10, Number(speedSlider.value)) - 1) * timeDirection;
};
function drawAstro(eclX, eclY, color, name) {
